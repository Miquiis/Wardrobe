package me.miquiis.wardrobe.client.renderers;
...
public class CustomPlayerRenderer extends LivingRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
   ...
   public CustomPlayerRenderer(EntityRendererManager renderManager, ResourceLocation playerSkin, boolean isSlim, boolean isChild, float progress) {
